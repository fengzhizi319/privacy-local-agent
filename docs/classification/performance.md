...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Layer 1: 规则引擎 (Pure Rules)** | 0.33 ms | 0.021 ms | 0.017 ms | 0.031 ms | 0.095 ms | 47679.3 |
| **Layer 2: 医疗 NER (Small-NER)** | 0.31 ms | 0.04 ms | 0.03 ms | 0.17 ms | 0.20 ms | 22956.82 |
| **Layer 3: 语义大模型 (Qwen2-VL)** | 0.05 ms | 0.03 ms | 0.03 ms | 0.03 ms | 0.03 ms | 34720.21 |
